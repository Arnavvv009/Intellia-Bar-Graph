...
const STORAGE_KEY = 'intellia_bargraphs_session_v1';
...
export default function App() {
  ...
  const handlePhaseComplete = (currentPhase, nextPhase) => {
    ...
    if (currentPhase === 'wonder') {
      unlockBadge('graph_explorer');
    } else if (currentPhase === 'story') {
      unlockBadge('bar_spotter');
    } else if (currentPhase === 'simulate') {
      unlockBadge('parts_pro');
    }
  };
  ...
  return (
    <div className="app-container">
      {/* Top Header Wrapper (Nav Bar + Home + Mute Toggle) - Hidden during Intro Phase */}
      {phase !== 'intro' && (
